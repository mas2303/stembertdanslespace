/**
 * Parcours Patrouille 3 — déblocages séquentiels (copie logique patrouille 1).
 * Modifiez CONFIG et les cartes dans patrouille-3.html.
 */
(function() {
    if (document.body.getAttribute('data-parcours') !== 'patrouille-3') return;

    /** Cartes / iframes : éditer `patrouille-3.html`. Similitude (4 photos) : `objetCle`, `messagesObjetAcceptes` + images point 6 dans le HTML. */
    var CONFIG = {
